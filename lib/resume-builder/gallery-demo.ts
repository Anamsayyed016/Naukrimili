...
export const GALLERY_CARD_ACCENT_BY_TEMPLATE: Record<string, GalleryCardAccent> = {
  ...
  'rosewood-modern': {
    glow: 'radial-gradient(circle, rgba(185,152,146,0.42) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(239,230,221,0.55) 0%, transparent 70%)',
    borderTint: 'hover:border-rose-200/55',
    hoverOverlay: 'from-rose-50/35',
  },
  'cascade-flow': {
    glow: 'radial-gradient(circle, rgba(243,183,167,0.42) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(245,238,232,0.55) 0%, transparent 70%)',
  ...
  'nordic-fusion': {
    glow: 'radial-gradient(circle, rgba(234,220,203,0.55) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(185,199,179,0.45) 0%, transparent 70%)',
  ...
  'prism-edition': {
    glow: 'radial-gradient(circle, rgba(192,124,99,0.42) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(174,184,166,0.45) 0%, transparent 70%)',
    borderTint: 'hover:border-orange-200/55',
    hoverOverlay: 'from-stone-50/35',
  },
  'monarch-edge': {
    glow: 'radial-gradient(circle, rgba(181,107,79,0.42) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(138,142,114,0.45) 0%, transparent 70%)',
    borderTint: 'hover:border-amber-200/55',
    hoverOverlay: 'from-amber-50/35',
  },
  'sterling-executive': {
    glow: 'radial-gradient(circle, rgba(199,143,114,0.42) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(185,119,91,0.35) 0%, transparent 70%)',
    borderTint: 'hover:border-orange-200/55',
    hoverOverlay: 'from-stone-50/35',
  },
  'executive-slate': {
    glow: 'radial-gradient(circle, rgba(124,147,168,0.42) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(111,143,164,0.35) 0%, transparent 70%)',
    borderTint: 'hover:border-slate-200/55',
