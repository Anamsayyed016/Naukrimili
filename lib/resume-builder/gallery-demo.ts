...
export const GALLERY_CARD_ACCENT_BY_TEMPLATE: Record<string, GalleryCardAccent> = {
  ...
  'graphite-crimson-executive': {
    glow: 'radial-gradient(circle, rgba(164,54,70,0.42) 0%, transparent 70%)',
    glowSecondary: 'radial-gradient(circle, rgba(36,52,74,0.35) 0%, transparent 70%)',
    borderTint: 'hover:border-rose-300/55',
    hoverOverlay: 'from-rose-50/30',
  },
...
> = {
  ...
  'graphite-crimson-executive': { firstName: 'Alexander', lastName: 'Thornton', jobTitle: 'Senior Product Manager' },
