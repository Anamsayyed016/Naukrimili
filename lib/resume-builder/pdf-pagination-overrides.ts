 ...
 * Used by resume-export.ts (Puppeteer) and FinalizeStep (browser print).
 * Layout packing core is shared with Live Preview via vertical-pack-layout.ts.
 *
...
${VERTICAL_PACK_LAYOUT_CSS}

/* PDF — reinforce page-break on layout shells */
.resume-container,
