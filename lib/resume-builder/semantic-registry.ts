...
export const SEMANTIC_SECTION_DEFINITIONS: SemanticSectionDefinition[] = [
  ...
  def({
    ...
    tokens: ['responsibilities', 'responsibility', 'duties'],
  ...
  def({
    id: 'skills',
    label: 'Skills',
    phrases: ['skills', 'key skills', 'professional skills', 'areas of expertise', 'expertise'],
    tokens: ['skills', 'skill', 'expertise'],
  ...
  def({
    ...
    tokens: ['training', 'courses', 'workshops'],
    nodeTypes: ['TRAINING'],
