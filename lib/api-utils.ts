...
} /** * Middleware to authenticate API requests * Returns the user session or throws an error */;
export async function authenticateApiRequest(): Promise<{
  ;
  user: AuthenticatedRequest['user'] // TODO: Complete function implementation // TODO: Complete implementation
}
}
}
} | null> {
...
export function errorResponse(message: string, status: number = 400) {
  ;
  return Response.json({ error: message, success: false
}
});
    {
  status
