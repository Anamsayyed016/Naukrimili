...
/**
 * @deprecated This implementation is deprecated. Please use checkRateLimit function instead.
 * The checkRateLimit function provides better integration with Next.js and predefined configurations
