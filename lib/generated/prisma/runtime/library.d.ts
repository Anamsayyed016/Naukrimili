 ...
 * ```
 */
declare function debugCreate(namespace: string): ((...args: Record<string, unknown>[]) => void) & {
    color: string;
    enabled: boolean;
    namespace: string;
    log: (...args: string[]) => void;
...
export declare function getPrismaClient(config: GetPrismaClientConfig): {
    new (optionsArg?: PrismaClientOptions): {
         ...
         * @returns
         */
        $executeRaw(query: TemplateStringsArray | Sql, ...values: Record<string, unknown>[]): PrismaPromise_2<unknown, any>;
        /**
         ...
         * @returns
         */
        $queryRaw(query: TemplateStringsArray | Sql, ...values: Record<string, unknown>[]): PrismaPromise_2<unknown, any>;
        /**
         ...
         * @returns
         */
        $transaction(input: Record<string, unknown>, options?: Record<string, unknown>): Promise<any>;
        /**
...
export declare function makeTypedQueryFactory(sql: string): (...values: Record<string, unknown>[]) => TypedSql<any[], unknown>;
...
declare interface PrismaPromise_2<TResult, TSpec extends PrismaOperationSpec<unknown> = any> extends Promise<TResult> {
     ...
     * @param transaction transaction options
     */
    catch<R = never>(onrejected?: ((reason: Record<string, unknown>) => R | PromiseLike<R>) | undefined | null, transaction?: PrismaPromiseTransaction): Promise<TResult | R>;
    /**
...
declare class RequestHandler {
    ...
    mapQueryEngineResult({ dataPath, unpacker }: RequestParams, response: QueryEngineResultData<any>): Record<string, unknown>;
    /**
