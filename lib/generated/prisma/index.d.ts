...
/**
   ...
   */
  $executeRaw<T = unknown>(query: TemplateStringsArray | Prisma.Sql, ...values: Record<string, unknown>[]): Prisma.PrismaPromise<number>;
   ...
   * Read more in our [docs](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client/raw-database-access).
   */
  $executeRawUnsafe<T = unknown>(query: string, ...values: Record<string, unknown>[]): Prisma.PrismaPromise<number>;
   ...
   * Read more in our [docs](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client/raw-database-access).
   */
  $queryRaw<T = unknown>(query: TemplateStringsArray | Prisma.Sql, ...values: Record<string, unknown>[]): Prisma.PrismaPromise<T>;
   ...
   * Read more in our [docs](https://www.prisma.io/docs/reference/tools-and-interfaces/prisma-client/raw-database-access).
   */
  $queryRawUnsafe<T = unknown>(query: string, ...values: Record<string, unknown>[]): Prisma.PrismaPromise<T>;
...
export namespace Prisma {
  ...
  */
   ...
   */
  export type PromiseReturnType<T extends (...args: Record<string, unknown>) => $Utils.JsPromise<any>> = PromiseType<ReturnType<T>>
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    other: {
      ...
      operations: {
        $executeRaw: {
          args: [query: TemplateStringsArray | Prisma.Sql, ...values: Record<string, unknown>[]],
          result: Record<string, unknown>
        }
        $executeRawUnsafe: {
          args: [query: string, ...values: Record<string, unknown>[]],
          result: Record<string, unknown>
        }
        $queryRaw: {
          args: [query: TemplateStringsArray | Prisma.Sql, ...values: Record<string, unknown>[]],
  ...
  export interface Prisma__JobClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
     ...
     */
    then<TResult1 = T, TResult2 = never>(onfulfilled?: ((value: T) => TResult1 | PromiseLike<TResult1>) | undefined | null, onrejected?: ((reason: Record<string, unknown>) => TResult2 | PromiseLike<TResult2>) | undefined | null): $Utils.JsPromise<TResult1 | TResult2>
    /**
     * Attaches a callback for only the rejection of the Promise.
     * @param onrejected The callback to execute when the Promise is rejected.
     * @returns A Promise for the completion of the callback.
     */
    catch<TResult = never>(onrejected?: ((reason: Record<string, unknown>) => TResult | PromiseLike<TResult>) | undefined | null): $Utils.JsPromise<T | TResult>
    /**
