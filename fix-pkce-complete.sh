...
echo "🔐 Implementing Complete PKCE Solution for Google OAuth 2.0..."
...
echo "🔧 Implementing proper PKCE configuration..."

# Backup current config
cp lib/nextauth-config.ts lib/nextauth-config.ts.backup-$(date +%Y%m%d-%H%M%S)

# Create the corrected NextAuth configuration with proper PKCE
  ...
  providers: [
    ...(googleClientId && googleClientSecret ? [
      Google({
        ...
        // ✅ Proper PKCE implementation for Google OAuth 2.0
        authorization: {
          params: {
            ...
            access_type: "offline",
            prompt: "consent",
            // ✅ PKCE parameters - NextAuth.js v5 handles these automatically
...
echo "✅ OAuth configuration updated with proper PKCE implementation"
...
echo "✅ Complete PKCE implementation applied successfully!"
echo "🔍 Check the logs with: pm2 logs naukrimili --lines 10"
echo ""
echo "📋 PKCE Implementation Summary:"
echo "  ✅ Code Verifier: Generated automatically by NextAuth.js v5"
echo "  ✅ Code Challenge: SHA256 hash of verifier, base64url encoded"
echo "  ✅ Challenge Method: S256 (SHA256)"
echo "  ✅ Storage: Handled internally by NextAuth.js framework"
echo "  ✅ Verification: Automatic during token exchange"
echo "  ✅ Google OAuth 2.0: Fully compatible"
