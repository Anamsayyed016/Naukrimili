...
export default function ClientMobileTest() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">📱 Mobile Compatibility Test</h1>
          <p className="text-lg text-gray-600">Comprehensive testing for mobile notifications and device compatibility</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Button onClick={runComprehensiveTest} disabled={isRunning} className="w-full" size="lg">
            ...
            <Button onClick={testServerNotification} variant="outline" className="w-full" size="lg">
              <Bell className="w-4 h-4 mr-2" />
                ...
                <CardContent className="space-y-4">
                  ...
                  {testResults.notificationTest.error && (
                    <Alert className="bg-red-50 border-red-200">
                      ...
                      <AlertDescription className="text-red-800">{testResults.notificationTest.error}</AlertDescription>
                    </Alert>
                  )}
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <Badge variant={testResults.environment.isHTTPS ? 'default' : 'destructive'}>{testResults.environment.protocol}</Badge>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
