...
export default function TemplatePreview({
  ...
  if (template === 'creative') {
    return (
      <div className="w-full aspect-[3/4] min-h-[280px] sm:min-h-[300px] max-h-[400px] p-2 sm:p-3 md:p-4 bg-white overflow-hidden" style={{ fontSize: 'clamp(7px, 1.2vw, 9px)', lineHeight: '1.3' }}>
