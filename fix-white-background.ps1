# Quick Fix for White Background Issue
Write-Host "🔧 Fixing white background issue..." -ForegroundColor Green

# 1. Stop the dev server
Write-Host "⏹️ Stopping development server..." -ForegroundColor Yellow
...
# 3. Create a working backup of the main page
Write-Host "📋 Creating backup..." -ForegroundColor Yellow
if (Test-Path "app\page.tsx") {
    Copy-Item "app\page.tsx" "app\page.tsx.backup"
}

# 4. Create a simple working homepage
Write-Host "🏠 Creating simple homepage..." -ForegroundColor Yellow
$simpleHomePage = @"
'use client';
...
Set-Content "app\page.tsx" $simpleHomePage

# 5. Start the dev server
Write-Host "🚀 Starting development server..." -ForegroundColor Yellow
Start-Process -NoNewWindow -FilePath "pnpm" -ArgumentList "dev"

Write-Host "✅ Fix applied! Check http://localhost:3000" -ForegroundColor Green
Write-Host "📝 If this works, the issue was with complex components (useAuth, Framer Motion, etc.)" -ForegroundColor Cyan
Write-Host "🔄 To restore original: Copy app\page.tsx.backup to app\page.tsx" -ForegroundColor Yellow
