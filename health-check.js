...
// Check 1: Package.json validationtry {
  ...
  if (!packageJson.dependencies.next) {
    issues.push('Next.js is not listed as a dependency')} else {}} catch (error) {
...
if (foundLockFiles.length === 0) {
  warnings.push('No lock file found')} else if (foundLockFiles.length > 1) {
  warnings.push(`Multiple lock files found: ${foundLockFiles.join(', ')}`)} else {}
