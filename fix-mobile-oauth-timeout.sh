...
echo "🔧 Optimizing Mobile OAuth Timeout Settings"
echo "============================================"

# Increase timeout from 10 seconds to 15 seconds and add better error handling
...
echo "✅ Mobile OAuth timeout settings optimized"

# Restart PM2 to apply changes
echo "🔄 Restarting PM2..."
pm2 restart naukrimili

echo "✅ Mobile OAuth timeout optimization complete!"
