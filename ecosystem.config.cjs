  ...
  apps: [
    {
      ...
      env: {
        ...
        IMPORT_FIELD_TRACE: process.env.IMPORT_FIELD_TRACE,
        UPLOAD_PIPELINE_DEBUG: process.env.UPLOAD_PIPELINE_DEBUG,
        CUSTOM_PARSER_ENABLED: process.env.CUSTOM_PARSER_ENABLED,
        CUSTOM_PARSER_MODE: process.env.CUSTOM_PARSER_MODE,
        CUSTOM_PARSER_CONFIDENCE_THRESHOLD: process.env.CUSTOM_PARSER_CONFIDENCE_THRESHOLD,
        CUSTOM_PARSER_QUALITY_THRESHOLD: process.env.CUSTOM_PARSER_QUALITY_THRESHOLD,
