...
echo "🔧 Final OAuth PKCE Configuration Fix..."
...
echo "🔧 Fixing OAuth configuration for Google Workspace compliance..."

# Create a comprehensive OAuth configuration that works with Google Workspace
  ...
  providers: [
    ...(googleClientId && googleClientSecret ? [
      Google({
        ...
        // ✅ Google Workspace compliant OAuth configuration
        authorization: {
          params: {
            ...
            access_type: "offline",
            prompt: "consent",
            // ✅ Enable PKCE for secure OAuth flows
...
echo "✅ OAuth configuration updated for Google Workspace compliance"
...
echo "✅ OAuth PKCE configuration fix applied successfully!"
