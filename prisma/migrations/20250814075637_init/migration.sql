/*
  ...
  - The primary key for the `JobBookmark` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- DropForeignKey
ALTER TABLE "public"."JobBookmark" DROP CONSTRAINT "JobBookmark_userId_fkey";

-- AlterTable
ALTER TABLE "public"."Job" ALTER COLUMN "createdBy" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "public"."JobBookmark" DROP CONSTRAINT "JobBookmark_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ALTER COLUMN "userId" SET DATA TYPE TEXT,
ADD CONSTRAINT "JobBookmark_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "JobBookmark_id_seq";
