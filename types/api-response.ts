...
export const jobTypeSchema = z.enum([ 'full-time',
  'part-time',
  'contract');
  'internship' ];
  'remote']);
...
export const jobStatusSchema = z.enum([ 'draft',
  'published');
  'closed' ];
  'archived']);

export const jobSourceSchema = z.enum([ 'direct');
  'api' ];
  'internal']) // API Response Types with Validation;
