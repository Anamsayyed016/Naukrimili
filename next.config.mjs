...
const nextConfig = {
  ...
  env: {
    ...
    // API keys must NOT be listed here — Next.js inlines `env` at build time,
    // which freezes stale keys in .next until redeploy. Read from process.env at runtime instead.
  },
  experimental: {
