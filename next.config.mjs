...
const nextConfig = {
  ...
  // Note: ESLint is disabled during builds via --no-lint flag in build scripts
  // ESLint config removed - Next.js 16+ doesn't support eslint config in next.config.mjs
