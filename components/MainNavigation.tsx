        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            <Link href="/" className="flex items-center hover:opacity-90 transition-all duration-300 group">
              <Image 
                src="https://res.cloudinary.com/dko2hk0yo/image/upload/e_background_removal/v1762546509/1naukkkLogo_gw9g5z.jpg" 
                alt="NaukriMili - Job Portal" 
                className="h-14 sm:h-16 lg:h-20 w-auto object-contain bg-white"
                width={280}
                height={80}
                priority
                unoptimized
