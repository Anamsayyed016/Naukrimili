  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* System Metrics */}
          <Card className={`p-4 border-l-4 ${getStatusColor(getMetricStatus(healthData.metrics.cpuUsage, 'cpu'))}`}>
          ...
          <Card className={`p-4 border-l-4 ${getStatusColor(getMetricStatus(healthData.metrics.memoryUsage, 'memory'))}`}>
            <div className="flex justify-between items-start mb-2">
          ...
          <Card className={`p-4 border-l-4 ${getStatusColor(getMetricStatus(healthData.metrics.diskSpace, 'disk'))}`}>
            <div className="flex justify-between items-start mb-2">
          ...
          <Card className={`p-4 border-l-4 ${getStatusColor(getMetricStatus(healthData.metrics.responseTime, 'responseTime'))}`}>
            <div className="flex justify-between items-start mb-2">
