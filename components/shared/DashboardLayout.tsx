...
export default function DashboardLayout({ sidebar, children, className }: DashboardLayoutProps) {
  return (
    <div className={clsx("min-h-screen flex bg-background text-foreground", className)}>
      {/* Sidebar */}
      <aside className="hidden md:block w-64 bg-sidebar-DEFAULT text-sidebar-foreground border-r border-sidebar-border dark:bg-sidebar-DEFAULT dark:text-sidebar-foreground">
        {sidebar}
      </aside>
      {/* Main Content */}
