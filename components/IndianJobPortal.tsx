          ...
          {!isLoading && !error && displayJobs.length === 0 && (searchQuery || location || jobType || selectedCategory) && (
            <div className="text-center py-16">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <a
                  href={`https://www.naukri.com/jobs-in-${location.toLowerCase().replace(/\s+/g, '-')}-${searchQuery.toLowerCase().replace(/\s+/g, '-')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-colors text-lg shadow-lg"
                >
                  <span>🇮🇳</span>
