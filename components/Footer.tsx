          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-white">
                <span className="text-indigo-400">Naukri</span>Mili
              </span>
            </div>
              ...
              <div className="flex flex-col space-y-2">
                <div className="flex">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-r-md transition-colors duration-200 flex items-center justify-center min-w-[100px] ${
                      status === 'loading' 
