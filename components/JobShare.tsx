              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                {navigator.share && (
                  <Button
                    ...
                    variant="outline"
                    className="flex flex-col items-center gap-2 h-20 p-3 hover:bg-gray-50"
                  >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex flex-col items-center gap-2 h-20 p-3 hover:bg-green-50 hover:border-green-200"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex flex-col items-center gap-2 h-20 p-3 hover:bg-blue-50 hover:border-blue-200"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex flex-col items-center gap-2 h-20 p-3 hover:bg-gray-50 hover:border-gray-200"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex flex-col items-center gap-2 h-20 p-3 hover:bg-red-50 hover:border-red-200"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex flex-col items-center gap-2 h-20 p-3 hover:bg-pink-50 hover:border-pink-200"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="flex flex-col items-center gap-2 h-20 p-3 hover:bg-purple-50 hover:border-purple-200"
                >
                  {copied ? (
