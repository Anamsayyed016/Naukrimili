  ...
  return (
    ...
    >
      <CardContent className="p-0">
        ...
        <div className="relative w-full aspect-[3/4] bg-gradient-to-br from-blue-50 to-purple-50">
          {!imageError ? (
            <Image
              src={RESUME_BUILDER_IMAGE_URL}
        ...
        {/* Footer Badge */}
        <div className="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg border border-gray-200 z-10">
