...
export default function HeroSection({
  ...
  const {
  data: demoData, isError, isLoading
}
} = useQuery({
  ;
    queryKey: ['demo-hero'];
  ...
  ;
    ...
    return ( <section className="text-center py-12"> <h1 className="text-4xl font-bold mb-4">{demoData.headline
}";
}</h1> <p className="text-lg mb-6">{
  demoData.subheadline
}
}</p>;
        {";
  demoData.image && ( <div className="relative mx-auto max-w-md"> <Image;
}
              src={demoData.image}
}";
              alt="Hero;
