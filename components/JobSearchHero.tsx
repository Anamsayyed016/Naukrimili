...
const JobSearchHeroAdvancedFiltersPanelLazy = dynamic(
  () =>
    import('./JobSearchHero').then((mod) => ({
      default: mod.JobSearchHeroAdvancedFiltersPanel,
    })),
  { ssr: false }
);
...
export default function JobSearchHero({ 
  ...
  // Load job constants only when advanced filters are opened
  useEffect(() => {
    if (!showAdvancedFilters || !showAdvanced) return;
    fetchDynamicConstants();
  }, [showAdvancedFilters, showAdvanced, fetchDynamicConstants]);
          ...
          >
            ...
            >
              ...
              {showAdvancedFilters && showAdvanced && (
                <JobSearchHeroAdvancedFiltersPanelLazy
                  filters={filters}
...
interface JobSearchHeroAdvancedFiltersPanelProps {
  filters: HeroFilters;
  setFilters: Dispatch<SetStateAction<HeroFilters>>;
  dynamicConstants: HeroDynamicConstants;
}

export function JobSearchHeroAdvancedFiltersPanel({
  filters,
  setFilters,
  dynamicConstants,
