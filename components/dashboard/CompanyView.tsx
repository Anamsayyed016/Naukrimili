      ...
      <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-white">23 applications</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-300">Last Week</span>
                        <span className="text-white">18 applications</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-300">Growth</span>
                        <span className="text-green-400">+27.8%</span>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-300">Most Views</span>
                        <span className="text-white">Senior React Developer</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-300">Most Applications</span>
                        <span className="text-white">Full Stack Engineer</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-300">Best Conversion</span>
        ...
        {activeTab === "post-job" && (
          ...
          >
            <Card className="bg-white/10 border-white/20">
              <CardHeader>
                <CardTitle className="text-white">Post New Job</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-300 mb-4">
                  Create a new job posting to attract top talent to your company.
                </p>
