        ...
        >
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <div className={`p-2 rounded-lg ${roleColor(userRole)} text-white`}>{roleIcon(userRole)}</div>
              <div>
          ...
          <div className="flex items-center gap-3">
            {actions.map((action, index) => (
              ...
              >
                <Button onClick={action.onClick} variant={action.variant || "default"} size="sm" className="flex items-center gap-2">
