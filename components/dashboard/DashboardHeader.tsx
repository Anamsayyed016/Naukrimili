  ...
  return (
    <div className="flex items-center justify-between mb-8">
      <div>
        ...
        <p className="text-gray-300 text-lg brand-tagline">{subtitle}</p>
      </div>
      <div className="flex items-center gap-3">
        ...
        {actions.map((action, index) => (
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-4 py-2 rounded-xl font-semibold shadow flex items-center"
          >
