...
} > <div className={`relative overflow-hidden rounded-lg bg-gradient-to-br ${stat.gradient}";
} p-4`}> <div className="flex items-center justify-between text-white"> <div> <p className="text-sm opacity-80">{
  stat.title
}";
