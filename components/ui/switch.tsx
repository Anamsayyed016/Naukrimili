...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "border-border/70 data-[state=unchecked]:bg-input hover:data-[state=unchecked]:bg-input/80",
      "data-[state=checked]:border-primary data-[state=checked]:bg-primary hover:data-[state=checked]:bg-primary/90",
