    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          ...
          // Responsive min-width: override trigger width on mobile, use it on desktop
          "min-w-0 sm:min-w-[var(--radix-select-trigger-width)]",
          // Ensure viewport respects container width on mobile
