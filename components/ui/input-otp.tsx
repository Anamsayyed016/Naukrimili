...
const InputOTPSlot = React.forwardRef<;";
  ...
  return ( <div;
      ...
      className={
  cn(;";
        "relative flex h-10 w-10 items-center justify-center border-y border-r border-input text-sm transition-all first: rounded-l-md first:border-l las,t: rounded-r-md";
}";
