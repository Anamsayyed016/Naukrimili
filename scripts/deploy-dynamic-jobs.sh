...
echo ""
echo "📝 Test URLs:"
echo "1. BPO jobs: https://naukrimili.com/jobs?query=bpo"
echo "2. Marketing jobs: https://naukrimili.com/jobs?query=marketing"
echo "3. Software jobs: https://naukrimili.com/jobs?query=software"
echo "4. Sales jobs: https://naukrimili.com/jobs?query=sales"
echo "5. HR jobs: https://naukrimili.com/jobs?query=hr"
echo "6. Design jobs: https://naukrimili.com/jobs?query=design"
echo ""
